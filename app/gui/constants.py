...
FIELDS: List[FieldDefinition] = [
    ...
    FieldDefinition("W", "Carga de trabajo (mA·min/sem)"),
...
LABEL_TO_FIELD: Dict[str, str] = {
    ...
    "TIPO PERSONA SOLICITANTE": "TIPO_SOLICITANTE",
    ...
    "RADICADO EQUIPO": "RADICADO_EQUIPO",
    "RADICADO DEL EQUIPO": "RADICADO_EQUIPO",
    "RADICADO E": "RADICADO_EQUIPO",
    "NIT": "NIT_CC",
    "NIT O CC": "NIT_CC",
    "NIT O C C": "NIT_CC",
    "NIT CC": "NIT_CC",
    ...
    "CATEGORIA EQUIPO": "CATEGORIA_EQUIPO",
    "CATEGORIA E": "CATEGORIA_EQUIPO",
    "CATEGORIA DEL EQUIPO LICENCIA": "CATEGORIA_EQUIPO",
    "MARCA": "MARCA",
    "MARCA E": "MARCA",
    "MODELO": "MODELO",
    "MODELO E": "MODELO",
    ...
    "FECHA RADICACION EQUIPO": "FECHA_RADICACION",
    "FECHA RADICACION E": "FECHA_RADICACION",
    "FECHA RADICACIÓN EQUIPO": "FECHA_RADICACION",
    "FECHA RADICACIÓN E": "FECHA_RADICACION",
    "RESOLUCION": "RESOLUCION",
    "RESOLUCIÓN": "RESOLUCION",
    "RESOLUCION E": "RESOLUCION_EQUIPO",
    "RESOLUCIÓN E": "RESOLUCION_EQUIPO",
    "RESOLUCION EQUIPO": "RESOLUCION_EQUIPO",
    "RESOLUCION DEL EQUIPO": "RESOLUCION_EQUIPO",
    "RESOLUCION EQUIPO LICENCIA": "RESOLUCION_EQUIPO",
    "RESOLUCIÓN EQUIPO": "RESOLUCION_EQUIPO",
    "RESOLUCIÓN DEL EQUIPO": "RESOLUCION_EQUIPO",
    "RESOLUCIÓN EQUIPO LICENCIA": "RESOLUCION_EQUIPO",
    "FECHA RESOLUCION": "FECHA_RESOLUCION",
    "FECHA RESOLUCIÓN": "FECHA_RESOLUCION",
    "FECHA RESOLUCION EQUIPO": "FECHA_RESOLUCION_EQUIPO",
    "FECHA RESOLUCION E": "FECHA_RESOLUCION_EQUIPO",
    "FECHA RESOLUCIÓN EQUIPO": "FECHA_RESOLUCION_EQUIPO",
    "FECHA RESOLUCIÓN E": "FECHA_RESOLUCION_EQUIPO",
    "FECHA RESOLUCION EQUIPO": "FECHA_RESOLUCION_EQUIPO",
    "FECHA RESOLUCION DEL EQUIPO": "FECHA_RESOLUCION_EQUIPO",
    "FECHA RESOLUCIÓN EQUIPO": "FECHA_RESOLUCION_EQUIPO",
    "FECHA RESOLUCIÓN DEL EQUIPO": "FECHA_RESOLUCION_EQUIPO",
    "FECHA HOY": "FECHA_HOY",
...
SECTION_LABEL_TO_FIELD: Dict[str, Dict[str, str]] = {
    ...
    "EQUIPOS A LICENCIAR": {
        ...
        "CATEGORIA EQUIPO": "CATEGORIA_EQUIPO",
        "CATEGORIA E": "CATEGORIA_EQUIPO",
        "RADICADO": "RADICADO_EQUIPO",
        "RADICADO E": "RADICADO_EQUIPO",
        "RADICADO EQUIPO": "RADICADO_EQUIPO",
        "RADICADO DEL EQUIPO": "RADICADO_EQUIPO",
        "FECHA RADICACION": "FECHA_RADICACION",
        "FECHA RADICACION EQUIPO": "FECHA_RADICACION",
        "FECHA RADICACION DEL EQUIPO": "FECHA_RADICACION",
        "FECHA RADICACION E": "FECHA_RADICACION",
        "FECHA RADICACIÓN": "FECHA_RADICACION",
        "FECHA RADICACIÓN EQUIPO": "FECHA_RADICACION",
        "FECHA RADICACIÓN DEL EQUIPO": "FECHA_RADICACION",
        "FECHA RADICACIÓN E": "FECHA_RADICACION",
        "KV": "KV",
        "K V": "KV",
        "MA": "MA",
        ...
        "CARGA DE TRABAJO": "W",
        "CARGA TRABAJO": "W",
        "RESOLUCION": "RESOLUCION_EQUIPO",
        "RESOLUCION EQUIPO": "RESOLUCION_EQUIPO",
        "RESOLUCION DEL EQUIPO": "RESOLUCION_EQUIPO",
        "RESOLUCIÓN": "RESOLUCION_EQUIPO",
        "RESOLUCIÓN EQUIPO": "RESOLUCION_EQUIPO",
        "RESOLUCIÓN DEL EQUIPO": "RESOLUCION_EQUIPO",
        "FECHA RESOLUCION": "FECHA_RESOLUCION_EQUIPO",
        "FECHA RESOLUCION EQUIPO": "FECHA_RESOLUCION_EQUIPO",
        "FECHA RESOLUCIÓN": "FECHA_RESOLUCION_EQUIPO",
        "FECHA RESOLUCIÓN EQUIPO": "FECHA_RESOLUCION_EQUIPO",
    },
}
