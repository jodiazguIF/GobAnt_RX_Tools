...
4. **Genera la licencia.**
   ...
   * Si manejas más de un equipo, reserva un párrafo que contenga únicamente `{{LISTA_EQUIPOS}}` en el lugar exacto donde quieras que aparezcan. La aplicación insertará allí un bloque numerado con todos los equipos que comparten el mismo radicado, replicando el formato estándar del acta. Las plantillas que aún usen los marcadores individuales seguirán tomando los datos del primer equipo.
